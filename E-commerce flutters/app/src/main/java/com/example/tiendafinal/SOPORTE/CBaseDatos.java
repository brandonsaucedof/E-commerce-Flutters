package com.example.tiendafinal.SOPORTE;
...
public class CBaseDatos extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create Table Usuario (codUsuario Integer Primary key autoincrement, Nombre text, Apellido text, Usuario text, contraseña text, direccion text)");
        ...
        db.execSQL("Create Table DetalleVenta (codDetalle Integer Primary Key autoincrement, cantidad int, precioProducto int, codVenta int, codUsuario int, codProducto int)");
